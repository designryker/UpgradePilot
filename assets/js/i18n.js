...
const I18N = {
  en: {
    title:'UpgradePilot — PC Performance & Upgrade Advisor',
    languageLabel:'Language',
    eyebrow:'// v0.3.2 — PC Performance & Upgrade Advisor',
    tagline:'Optimize first. Upgrade smart.',
    subtitle:'Fill in your current specs. UpgradePilot will tell you what is likely limiting you, what free fixes to try first, and <strong>only then</strong> whether a hardware upgrade is actually worth the money.',
  ...
  tr: {
    title:'UpgradePilot — PC Performans ve Yükseltme Danışmanı',
    languageLabel:'Dil',
    eyebrow:'// v0.3.2 — PC Performans ve Yükseltme Danışmanı',
    tagline:'Önce optimize et. Sonra akıllıca yükselt.',
    subtitle:'Mevcut sistem bilgilerini gir. UpgradePilot sana sistemi neyin sınırladığını, önce hangi ücretsiz kontrolleri yapman gerektiğini ve gerçekten parça yükseltmeye değip değmediğini söyler.',
